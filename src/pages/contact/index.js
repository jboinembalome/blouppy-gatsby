...
export default class Index extends React.Component {
  ...
  render() {
    ...
    function ContactInformation() {
      return <div className="relative overflow-hidden py-10 px-6 border border-transparent rounded-t-lg lg:rounded-t-none lg:rounded-l-lg shadow bg-violet-700 dark:bg-violet-500 sm:px-10 xl:p-12">
