...
export const Moon = ({ selected, ...props }: SvgSelectedProps) => (
  <svg viewBox="0 0 24 24" fill="none" {...props}>
    ...
    <path
      ...
      className={
        selected ? "fill-violet-500" : "fill-gray-400 dark:fill-gray-500"
      }
    />
    <path
      fillRule="evenodd"
...
export const Sun = ({ selected, ...props }: SvgSelectedProps) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    strokeWidth="2"
